...
``[options.entry_points]`` section in ``setup.cfg``::
    ...
    console_scripts =
         genz-polkadot-pool = avalanche_docker_pool.skeleton:run
...
from avalanche_docker_pool import __version__
import avalanche_docker_pool.config_cli as config_cli
import avalanche_docker_pool.relay_cli as relay_cli
import avalanche_docker_pool.staking_cli as staking_cli
import avalanche_docker_pool.wallet_cli as wallet_cli
...
if __name__ == "__main__":
    ...
    #
    #     python -m avalanche_docker_pool.skeleton 42
    #
    run()
